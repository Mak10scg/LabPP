...
class Program
{
    static void Main()
    {
        ...
        if (vectors.Count >= 2)
        {
            Console.WriteLine("Сумма первых двух вектров = " + Vector2D.Sum(vectors[0], vectors[1]));
            Console.WriteLine("Разность первых двух вектров = " + Vector2D.Minus(vectors[0], vectors[1]));
            Console.WriteLine("Умножение вектора на скаляр = " + Vector2D.Multyply(vectors[0], scalar));
        }
